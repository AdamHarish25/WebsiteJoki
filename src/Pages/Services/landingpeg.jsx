import landpage from "../../assets/Landingpej.webp";
import feature1 from "../../assets/DesignCreative.webp";
import feature2 from "../../assets/ContentWriting.webp";
import feature3 from "../../assets/digitalIntergration.webp";
        ...
        <div className={className.container}>
            ...
            <section className={`${className.section} flex flex-col-reverse md:flex-row justify-center gap-10 items-center`}>
                <div className="md:w-full text-left">
                    ...
                    <Link to="https://wa.me/6285179808325" target="_blank" className={className.button}>Buat Landing Page ➜</Link>
                </div>
                <div className="w-full md:w-3/4 grid place-items-center">
                    <img src={landpage} alt="Landing Page" className="w-fit lg:w-full" />
                </div>
            </section>
            ...
            <section className={className.section}>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className={className.card}>
                        ...
                        <p className="text-gray-500 text-base">Tampilan profesional & responsif yang disesuaikan dengan branding bisnis Anda.</p>
                    </div>

                    <div className={className.card}>
                        <img src={feature2} alt="Feature 2" className="w-20 h-20" />
                        <h3 className="text-xl font-semibold">Copywriting Menjual</h3>
                        <p className="text-gray-500 text-base">Teks persuasif untuk menarik pelanggan dan meningkatkan konversi.</p>
                    </div>

                    <div className={className.card}>
                        <img src={feature3} alt="Feature 3" className="w-20 h-20" />
                        <h3 className="text-xl font-semibold">Integrasi Digital</h3>
                        <p className="text-gray-500 text-base">Terintegrasi dengan WhatsApp, Google Analytics, & Meta Pixel.</p>
                    </div>
                </div>
            </section>
            ...
            <section className={`${className.section} bg-gray-50 rounded-lg`}>
                <h2 className={className.heading}>Kenapa Pilih<span className={className.highlight}> WebsiteJokiID?</span></h2>
                <div className="grid md:grid-cols-3 gap-8 mt-8">
                    <div>
                        ...
                        <p className="text-gray-500 text-base">Desain yang menarik dan menyesuaikan dengan identitas brand Anda.</p>
                    </div>
                    <div>
                        <h3 className="text-Emerald-green text-3xl font-bold mb-2">02</h3>
                        <p className="text-gray-700 font-semibold">Harga Terjangkau</p>
                        <p className="text-gray-500 text-base">Cocok untuk UMKM hingga perusahaan besar.</p>
                    </div>
                    <div>
                        ...
                        <p className="text-gray-500 text-base">Konsultasi gratis sebelum dan sesudah pembuatan landing page.</p>
                    </div>
                </div>
            </section>
            ...
            <section className={className.section}>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className={className.priceCard}>
                        ...
                        <Link to='https://wa.me/6285179808325' target="_blank" className={className.button}>Pesan Sekarang</Link>
                    </div>
            ...
            {/* <section className={className.section}>
                ...
                <div className="mt-8 space-y-6">
                    <details className={`px-4 py-2 rounded-lg hover:bg-white hover:border-Emerald-green border ${isClicked == true ? "bg-white border-Emerald-green" : "bg-gray-100 border-white"}`} onClick={() => {
                        ...
                        <p className="text-gray-500 mt-2 text-base">Ya, semua paket kami sudah termasuk domain dan hosting selama 1 tahun.</p>
                    </details>
