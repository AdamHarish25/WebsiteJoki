...
import { Link, useLocation, useNavigate } from "react-router"; // or react-router-dom if you use that!
    ...
    <nav className="bg-white shadow-md py-4 px-10 fixed w-full z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center relative">
          ...
          <Link to="/">
            <Tooltip message={"Ke Beranda ->"}>
              <img
                src={Logo}
                alt="Logo"
                className="w-52 group-hover:w-56 transition-all duration-200"
              />
            </Tooltip>
          </Link>
        </div>
        ...
        <ul className="hidden md:flex space-x-8 text-gray-700 items-center">
          <li className="hover:text-Emerald-green cursor-pointer transition">
              ...
              <div className="grid grid-cols-4 gap-6 p-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="hover:text-Emerald-green cursor-pointer line-through">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="hover:text-Emerald-green cursor-pointer">
      ...
      >
        ...
        >
          <Tooltip message={"Ke Beranda ->"}>
            <img
              src={Logo}
              alt="Logo"
              className="mb-10 w-52 group-hover:w-56 transition-all duration-200"
            />
          </Tooltip>
        </Link>
        ...
        <ul className="flex flex-col space-y-6 items-center w-full">
          ...
          <li
            className={`hover:text-Emerald-green cursor-pointer transition duration-500 flex justify-between items-center px-10 ${
              showMobileDropdown ? "w-full" : "w-fit"
            }`}
